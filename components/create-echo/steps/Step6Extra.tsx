...
export default function Step6Extra({ onNext, onPrev, onSelect, selected }: Props) {
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.title}>Step 6: Choose extra options</Text>
      {echoOptions.extras.map((e) => {
